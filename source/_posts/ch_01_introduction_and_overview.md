...
TCP/IP 的设计者将这一层命名为 `网络接口层（Network Interface）`，但一些协会更喜欢称为 `数据链路层（Data Link）`，工业界又喜欢称为 `媒介访问控制层（Media Access Control, MAC）`
...
![OSI协议](/ch_01_introduction_and_overview/2019-11-22-23-01-16.png)
