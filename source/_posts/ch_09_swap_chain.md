...
`createInfo` 中 `surfaceFormat` ，`presentMode` 和 `extent` 都是在 [Choosing the right settings for the swap chain](/ch_09_swap_chain/#Choosing_the_right_settings_for_the_swap_chain) 中获取的数据。
