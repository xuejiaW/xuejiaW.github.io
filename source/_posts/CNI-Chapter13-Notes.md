...
![电路交换](CNI-Chapter13-Notes/2019-12-09-08-28-27.png)
...
![分组交换](CNI-Chapter13-Notes/2019-12-09-08-37-20.png)
...
分组交换的主要有点在于成本的控制。对于电路交换来说，如果有$N$个电脑，则需要$N/2$个独立的路径（虽然在连接时才创建）。但对于分组交换只要一个共享的电路就行。
...
![802协议](CNI-Chapter13-Notes/2019-12-09-09-25-59.png)
...
![包的机构](CNI-Chapter13-Notes/2019-12-09-10-47-15.png)
...
![包的例子](CNI-Chapter13-Notes/2019-12-09-10-49-20.png)
